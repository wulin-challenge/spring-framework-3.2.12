...
public class CustomTokenDelegateSecurityContextRepository implements SecurityContextRepository{
	 ...
	 * @return
	 */
	public RequestMatcher buildPersistenceRequestMatcher() {
		return new CustomTokenRequestMatcher(new CustomTokenPersistenceRequestMatcher());
	}
	/**
	 * 构建sessionRepository
	 */
	public SecurityContextRepository buildSessionRepository() {
	...
	public SecurityContextRepository getDelegateRepository() {
