package cn.wulin.security.test.token;
...
import cn.wulin.security.test.util.GsonUtil;
import cn.wulin.security.test.util.HttpClientUtil;
...
public class TestAppToken {
	...
	public static final String TOKEN_LOGIN_URL = "http://localhost:8081/spring-source-analysis-security/login";
	public static final String TOKEN_ROLEUSER_URL = "http://localhost:8081/spring-source-analysis-security/role/getRoleUser";
