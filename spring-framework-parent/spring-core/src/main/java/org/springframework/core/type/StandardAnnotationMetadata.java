 ...
 * 
 * <p> AnnotationMetadata实现，它使用标准反射来内省给定的类。
 *
...
public class StandardAnnotationMetadata extends StandardClassMetadata implements AnnotationMetadata {
	 ...
	 * 
	 * <p> 为给定的类创建一个新的StandardAnnotationMetadata包装器。
	 * 
	 * @param introspectedClass the Class to introspect - 内省的类
	 * 
	 ...
	 * 
	 * <p> 为给定的类创建一个新的StandardAnnotationMetadata包装器，
	 * 提供以AnnotationAttributes形式而不是实际的Annotation实例返回任何嵌套注释或注释数组的选项。
	 * 
	 * @param introspectedClass the Class to instrospect - 内省的类
	 * 
	 * @param nestedAnnotationsAsMap return nested annotations and annotation arrays as
	 * {@link AnnotationAttributes} for compatibility with ASM-based
	 * {@link AnnotationMetadata} implementations
	 * 
	 * <p> 将嵌套注释和注释数组作为AnnotationAttributes返回，以便与基于ASM的AnnotationMetadata实现兼容
	 * 
	 * @since 3.1.1
	 */
