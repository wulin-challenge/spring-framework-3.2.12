 ...
 * 
 * <p> org.springframework.core.io.Resource数组的编辑器，用于自动将String位置模式
 * （例如“file：C：/my*.txt”或“classpath *：myfile.txt”）转换为Resource数组属性。 
 ...
 * 
 * <p> 路径可能包含$ {...}}占位符，需要解析为org.springframework.core.env.Environment属性：
 * 例如$ {user.dir来}}。 默认情况下会忽略不可解析的占位符。
 *
 * <p>Delegates to a {@link ResourcePatternResolver},
 * by default using a {@link PathMatchingResourcePatternResolver}.
 * 
 * <p> 默认情况下，使用PathMatchingResourcePatternResolver委派给ResourcePatternResolver。
 *
...
public class ResourceArrayPropertyEditor extends PropertyEditorSupport {
	 ...
	 * 
	 * <p> 使用默认的PathMatchingResourcePatternResolver和StandardEnvironment
	 * 创建一个新的ResourceArrayPropertyEditor。
	 * 
	 * @see PathMatchingResourcePatternResolver
	 * @see Environment
	 */
