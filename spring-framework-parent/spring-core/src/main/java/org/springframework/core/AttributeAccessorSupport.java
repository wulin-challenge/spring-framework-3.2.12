...
public abstract class AttributeAccessorSupport implements AttributeAccessor, Serializable {
	 ...
	 * 
	 * <p> 将属性从提供的AttributeAccessor复制到此访问器。
	 * 
	 * @param source the AttributeAccessor to copy from - 要从中复制的AttributeAccessor
	 */
