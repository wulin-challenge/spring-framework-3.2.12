...
public class AnnotationTypeFilter extends AbstractTypeHierarchyTraversingFilter {
	 ...
	 * 
	 * <p> 为给定的注释类型创建一个新的AnnotationTypeFilter。 此过滤器还将匹配元注释。
	 *  要禁用元注释匹配，请使用接受“ConsideMetaAnnotations”参数的构造函数。 过滤器与接口不匹配。
	 * 
	 * @param annotationType the annotation type to match - 要匹配的注释类型
	 */
	 ...
	 * 
	 * <p> 为给定的注释类型创建一个新的AnnotationTypeFilter。 过滤器与接口不匹配。
	 * 
	 * @param annotationType the annotation type to match - 要匹配的注释类型
