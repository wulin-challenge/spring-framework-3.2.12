 ...
 * 
 * <p> 方便的实用程序方法，用于加载java.util.Properties，执行输入流的标准处理。
 *
 ...
 * 
 * <p> 要获得更多可配置的属性加载，包括自定义编码选项，请考虑使用PropertiesLoaderSupport类。
 *
...
public abstract class PropertiesLoaderUtils {
	 ...
	 * 
	 * <p> 从给定的EncodedResource加载属性，可能定义属性文件的特定编码。
	 * 
	 ...
	 * potentially defining a specific encoding for the properties file.
	 * 
	 * <p> 从给定的EncodedResource填充给定的属性，可能为属性文件定义特定的编码。
	 * 
	 ...
	 * 
	 * <p> 实际上将给定EncodedResource的属性加载到给定的Properties实例中。
	 * 
	 * @param props the Properties instance to load into
	 * 
	 * <p> 要加载的Properties实例
