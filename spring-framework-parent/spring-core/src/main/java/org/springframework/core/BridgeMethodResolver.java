 ...
 * 
 * <p> 给定合成桥接方法返回被桥接的方法。 当扩展其方法具有参数化参数的参数化类型时，编译器可以创建桥接方法。 
 * 在运行时调用期间，可以通过反射调用和/或使用桥接方法。 在尝试在方法上查找注释时，最好根据需要检查桥接方法并找到桥接方法。
 *
 * <p>See <a href="http://java.sun.com/docs/books/jls/third_edition/html/expressions.html#15.12.4.5">
 * The Java Language Specification</a> for more details on the use of bridge methods.
 *
 * <p> 有关使用桥接方法的更多详细信息，请参阅Java语言规范。
 * 
 * @author Rob Harrop
...
public abstract class BridgeMethodResolver {
	 ...
	 * 
	 * <p> 调用此方法传入非桥接方法实例是安全的。 在这种情况下，提供的Method实例将直接返回给调用者。 
	 * 在调用此方法之前，调用者不需要检查桥接。
	 * 
	 * @param bridgeMethod the method to introspect - 内省的方法
	 * @return the original method (either the bridged method or the passed-in method
	 * if no more specific one could be found)
	 * 
	 * <p> 原始方法（如果找不到更具体的方法，可以使用桥接方法或传入方法）
	 * 
	 */
