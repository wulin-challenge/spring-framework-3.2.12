 ...
 * 
 * <p>用于解析String值的简单策略接口。 由org.springframework.beans.factory.config.ConfigurableBeanFactory使用。
 *
...
public interface StringValueResolver {
	 ...
	 * 
	 * @param strVal the original String value - 原始的String值
	 * @return the resolved String value - 已解析的String值
	 */
