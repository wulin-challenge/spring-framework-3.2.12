 ...
 * 
 * <p> JDBC javax.sql.DataSource实现，它将所有调用委托给给定目标javax.sql.DataSource。
 *
 ...
 * 
 * <p> 此类用于子类化，子类仅覆盖那些不应简单地委托给目标DataSource的方法（例如getConnection（））。
 *
...
public class DelegatingDataSource implements DataSource, InitializingBean {
	 ...
	 * <p> 创建一个新的DelegatingDataSource。
	 * 
	 * @param targetDataSource the target DataSource - 目标DataSource
	 */
	 ...
	 * 
	 * <p> 设置此DataSource应委派给的目标DataSource。
	 * 
	 */
