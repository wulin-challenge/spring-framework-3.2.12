 ...
 * 
 * <p> 使用JDBC的通用实用程序方法。 主要供框架内部使用，也适用于自定义JDBC访问代码。
 *
...
public abstract class JdbcUtils {
	 ...
	 * 
	 * <p> 关闭给定的JDBC Connection并忽略任何抛出的异常。 这对手动JDBC代码中的典型finally块非常有用。
	 * 
	 * @param con the JDBC Connection to close (may be {@code null})
	 * 
	 * <p> 要关闭的JDBC连接（可能为null）
	 * 
	 */
	public static void closeConnection(Connection con) {
		if (con != null) {
			try {
				...
				// 我们不信任JDBC驱动程序：它可能会抛出RuntimeException或Error。
	 ...
	 * This is useful for typical finally blocks in manual JDBC code.
	 * 
	 * <p> 关闭给定的JDBC语句并忽略任何抛出的异常。 这对手动JDBC代码中的典型finally块非常有用。
	 * 
	 * @param stmt the JDBC Statement to close (may be {@code null})
	 * 
	 * <p> 要关闭的JDBC语句（可能为null）
	 */
	 ...
	 * This is useful for typical finally blocks in manual JDBC code.
	 * 
	 * <p> 关闭给定的JDBC ResultSet并忽略任何抛出的异常。 这对手动JDBC代码中的典型finally块非常有用。
	 * 
	 * @param rs the JDBC ResultSet to close (may be {@code null})
	 * 
	 * <p> 要关闭的JDBC ResultSet（可能为null）
	 * 
	 */
