 ...
 * 
 * <p> 请参阅org.springframework.aop.support.AopUtils以获取不依赖于AOP框架内部的通用AOP实用程序方法的集合。
 *
 * @author Rod Johnson
...
public abstract class AopProxyUtils {
	 ...
	 * 
	 * <p> 确定给定bean实例的最终目标类，不仅遍历顶级代理，而且遍历任意数量的嵌套代理 - 尽可能长时间没有副作用，即仅针对单例目标。
	 * 
	 ...
	 * 
	 * <p> 确定要为给定AOP配置代理的完整接口集。
	 * 
	 * <p>This will always add the {@link Advised} interface unless the AdvisedSupport's
	 * {@link AdvisedSupport#setOpaque "opaque"} flag is on. Always adds the
	 * {@link org.springframework.aop.SpringProxy} marker interface.
	 * 
	 * <p> 这将始终添加Advised接口，除非AdvisedSupport的“opaque”标志已打开。 始终添加org.springframework.aop.SpringProxy标记接口。
	 * 
	 ...
	 * 
	 * <p> 提取给定代理实现的用户指定的接口，即代理实现的所有非Advised接口。
	 * 
	 ...
	 * 
	 * <p> 代理实现的所有用户指定的接口，按原始顺序（从不为null或为空）
	 * 
	 * @see Advised
	 */
	 ...
	 * 
	 * <p> 检查给定AdvisedSupport对象后面的代理的相等性。 与AdvisedSupport对象的相等性不同：相反，接口，顾问程序和目标源的相等性。
	 * 
	 */
	 ...
	 * 
	 * <p> 检查给定AdvisedSupport对象后面的代理接口的相等性。
	 * 
	 */
	 ...
	 * 
	 * <p> 检查给定AdvisedSupport对象后面的顾问程序的相等性。
	 * 
	 */
