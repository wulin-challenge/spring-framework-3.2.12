...
public class ReflectiveAspectJAdvisorFactory extends AbstractAspectJAdvisorFactory {
	 ...
	 * 
	 * <p> 为给定的介绍字段构建org.springframework.aop.aspectj.DeclareParentsAdvisor。
	 * 
	 * <p>Resulting Advisors will need to be evaluated for targets.
	 * 
	 * <p> 需要对结果顾问进行目标评估。
	 * 
	 * @param introductionField the field to introspect - 该属性是内省的
	 * @return {@code null} if not an Advisor -如果不是Advisor，则为null 
	 */
	...
	private AspectJExpressionPointcut getPointcut(Method candidateAdviceMethod, Class<?> candidateAspectClass) {
		...
		//使用 AspectJExpressionPointcut实例封装获取的信息
		AspectJExpressionPointcut ajexp =
	...
	public Advice getAdvice(Method candidateAdviceMethod, AspectJExpressionPointcut ajexp,
		...
		// 如果我们到这里，我们知道我们有一个AspectJ方法。 检查它是否是AspectJ注释类
