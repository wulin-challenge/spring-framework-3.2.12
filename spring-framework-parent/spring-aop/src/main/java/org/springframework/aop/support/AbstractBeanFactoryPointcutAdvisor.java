 ...
 * 
 * <p> 基于BeanFactory的抽象PointcutAdvisor，允许将任何建议配置为对BeanFactory中的Advice bean的引用。
 *
 ...
 * 
 * <p> 指定通知bean的名称而不是通知对象本身（如果在BeanFactory中运行）会在初始化时增加松散耦合，以便在切入点实际匹配之前不初始化通知对象。
 *
...
public abstract class AbstractBeanFactoryPointcutAdvisor extends AbstractPointcutAdvisor implements BeanFactoryAware {
	 ...
	 * of the advisor.
	 * 
	 * <p> 首次访问此顾问的建议时，将获得指定bean的实例。 此顾问程序最多只能获取一个advice bean的单个实例，
	 * 在实例的生命周期内缓存该实例。
	 * 
	 * @see #getAdvice()
	 */
