 ...
 *
 * <p> Helper用于从BeanFactory检索@AspectJ bean并基于它们构建Spring Advisors，用于自动代理。
 * 
...
public class BeanFactoryAspectJAdvisorsBuilder {
	 ...
	 * 
	 * <p> 为给定的BeanFactory创建一个新的BeanFactoryAspectJAdvisorsBuilder。
	 * 
	 * @param beanFactory the ListableBeanFactory to scan - 要扫描的ListableBeanFactory
	 */
	 ...
	 * 
	 * <p> AspectJAdvisorFactory用于构建每个Advisor
	 * 
	 */
	 ...
	 * 
	 * <p> 在当前的bean工厂中查找带AspectJ注释的方面bean，并返回到代表它们的Spring AOP Advisors列表。
	 * 
	 * <p>Creates a Spring Advisor for each AspectJ advice method.
	 * 
	 * <p> 为每个AspectJ advice方法创建一个Spring Advisor。
	 * 
