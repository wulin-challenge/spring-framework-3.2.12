 ...
 * 添加对通过AnnotatedBeanDefinition接口公开的注释元数据的支持。
 *
 ...
 * 例如Spring的组件扫描支持中的策略实现（其中默认定义类是
...
public class AnnotatedGenericBeanDefinition extends GenericBeanDefinition implements AnnotatedBeanDefinition {
	 ...
	 * 
	 * <p> 为给定的bean类创建一个新的AnnotatedGenericBeanDefinition。
	 * 
	 ...
	 * 
	 * <p> 为给定的注释元数据创建新的AnnotatedGenericBeanDefinition，允许基于ASM的处理并避免早期加载bean类。 
	 * 请注意，此构造函数在功能上等同于ScannedGenericBeanDefinition，
	 * 但后者的语义表示通过组件扫描而不是其他方式发现了bean。
	 * 
