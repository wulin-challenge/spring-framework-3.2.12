 ...
 * 
 * <p>Spring bean DTD的EntityResolver实现，从Spring类路径（或JAR文件）加载DTD。
 *
 ...
 * 
 * <p>从类路径资源“/org/springframework/beans/factory/xml/spring-beans-2.0.dtd”获
 * 取“spring-beans-2.0.dtd”，无论是否指定为包含“spring-beans”的本地URL “在DTD名称中
 * 或”http://www.springframework.org/dtd/spring-beans-2.0.dtd“。
 *
