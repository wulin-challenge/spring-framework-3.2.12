...
class ConstructorResolver {
	 ...
	 * 
	 * <p> “autowire构造函数”（带有类型的构造函数参数）行为。 如果指定了显式构造函数参数值，则还应用，
	 ...
	 * @param chosenCtors chosen candidate constructors (or {@code null} if none) - 选择的候选构造函数（如果没有则为null）
	 * @param explicitArgs argument values passed in programmatically via the getBean method,
	 * or {@code null} if none (-> use constructor argument values from bean definition)
	 * 
	 * <p> 通过getBean方法以编程方式传递的参数值，如果没有则为null（ - >使用bean定义中的构造函数参数值）
	 * 
	 ...
	 * 
	 * <p> 将此bean的构造函数参数解析为resolvedValues对象。 这可能涉及查找其他bean。 此方法还用于处理静态工厂方法的调用。
	 */
