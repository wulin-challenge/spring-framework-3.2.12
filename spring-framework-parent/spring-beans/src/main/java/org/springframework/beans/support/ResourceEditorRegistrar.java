 ...
 *
 * <p> PropertyEditorRegistrar实现，它使用资源编辑器填充给定的
 * org.springframework.beans.PropertyEditorRegistry（通常是用于在
 * org.springframework.context.ApplicationContext中创建bean的org.springframework.beans.BeanWrapper）。 
...
public class ResourceEditorRegistrar implements PropertyEditorRegistrar {
	 ...
	 * 
	 * <p> 使用StandardEnvironment为给定的ResourceLoader创建新的ResourceEditorRegistrar。
	 * 
	 * @param resourceLoader the ResourceLoader (or ResourcePatternResolver)
	 * to create editors for (usually an ApplicationContext)
	 * 
	 * <p> ResourceLoader（或ResourcePatternResolver）为（通常是ApplicationContext）创建编辑器
	 * 
	 ...
	 * 
	 * <p> 从Spring 3.1开始，赞成ResourceEditorRegistrar（ResourceLoader，PropertyResolver）
	 */
	@Deprecated
	 ...
	 * 
	 * <p> 为给定的ResourceLoader和PropertyResolver创建一个新的ResourceEditorRegistrar。
	 * 
	 * @param resourceLoader the ResourceLoader (or ResourcePatternResolver)
	 * to create editors for (usually an ApplicationContext)
	 * 
	 ...
	 * 
	 * <p> 如果此注册器已配置ResourcePatternResolver，则还将注册ResourceArrayPropertyEditor。
	 * 
	 ...
	 * 
	 * <p> 如果可能的话，覆盖默认编辑器（因为这是我们在这里真正要做的）; 否则注册为自定义编辑器。
	 * 
	 */
