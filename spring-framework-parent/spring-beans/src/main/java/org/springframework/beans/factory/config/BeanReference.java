 ...
 * 
 * <p> 以抽象方式公开对bean名称的引用的接口。 此接口不一定意味着对实际bean实例的引用; 它只是表达了bean名称的逻辑引用。
 *
 ...
 * 
 * <p> 用作由任何类型的bean引用持有者实现的公共接口，例如RuntimeBeanReference和RuntimeBeanNameReference。
 *
