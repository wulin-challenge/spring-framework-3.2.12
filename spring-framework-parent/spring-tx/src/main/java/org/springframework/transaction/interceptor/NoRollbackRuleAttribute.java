 ...
 * 
 * <p> RollbackRuleAttribute的标记子类，与RollbackRuleAttribute超类具有相反的行为。
 *
 * @author Rod Johnson
 * @since 09.04.2003
 */
...
public class NoRollbackRuleAttribute extends RollbackRuleAttribute {
	 ...
	 * 
	 * <p> 为提供的Throwable类创建NoRollbackRuleAttribute类的新实例。
	 * 
	 ...
	 * 
	 * <p> 为提供的exceptionName创建NoRollbackRuleAttribute类的新实例。
	 * 
