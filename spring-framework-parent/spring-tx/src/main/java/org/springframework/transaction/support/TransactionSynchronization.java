 ...
 * 
 * <p> 事务同步回调的接口。 由AbstractPlatformTransactionManager支持。
 *
 ...
 * 
 * <p> Spring执行的系统同步使用特定的顺序值，允许与其执行顺序（如果需要）进行细粒度的交互。
 *
...
public interface TransactionSynchronization {
	 ...
	 * 
	 * <p> 暂停此同步。 如果管理任何资源，则假定从TransactionSynchronizationManager取消绑定资源。
	 * 
	 ...
	 * 
	 * <p> 恢复此同步。 如果管理任何资源，则假定将资源重新绑定到TransactionSynchronizationManager。
	 * 
	 ...
	 * 
	 * <p> 如果适用，将基础会话刷新到数据存储区：例如，Hibernate / JPA会话。
	 * 
