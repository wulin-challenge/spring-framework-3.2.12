 ...
 * 
 * <p> 用于在所有当前注册的同步上触发特定TransactionSynchronization回调方法的实用程序方法。
 *
...
public abstract class TransactionSynchronizationUtils {
	 ...
	 * 
	 * <p> 在所有当前注册的同步上触发beforeCompletion回调。
	 * 
	 ...
	 * 
	 * <p> 实际上调用给定的Spring TransactionSynchronization对象的afterCommit方法。
	 * 
	 ...
	 * 
	 * <p> 在所有当前注册的同步上触发afterCompletion回调。
	 * 
	 * @see TransactionSynchronizationManager#getSynchronizations()
