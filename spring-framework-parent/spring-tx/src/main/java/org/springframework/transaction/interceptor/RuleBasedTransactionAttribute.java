...
public class RuleBasedTransactionAttribute extends DefaultTransactionAttribute implements Serializable {
	 ...
	 * 
	 * <p> 使用默认设置创建新的RuleBasedTransactionAttribute。 可以通过bean属性setter进行修改。
	 * 
	 ...
	 * 
	 * <p> 要应用的RollbackRuleAttributes列表
	 * 
	 * @see #setIsolationLevel
	 * @see #setTimeout
	 * @see #setReadOnly
	 ...
	 * 
	 * <p> 设置要应用的RollbackRuleAttribute对象（和/或NoRollbackRuleAttribute对象）的列表。
	 * 
	 ...
	 * (never {@code null}).
	 * 
	 * <p> 返回RollbackRuleAttribute对象的列表（从不为null）。
	 * 
	 */
	 ...
	 * return false.
	 * 
	 * <p> 获胜规则是最浅的规则（即，继承层次结构中最接近异常的规则）。 如果没有规则适用（-1），则返回false。
	 * 
