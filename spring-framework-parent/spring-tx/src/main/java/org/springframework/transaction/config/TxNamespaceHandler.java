 ...
 * 
 * <p> NamespaceHandler允许使用XML或使用注释来配置声明式事务管理。
 *
 * <p>This namespace handler is the central piece of functionality in the
 * Spring transaction management facilities and offers two approaches
 * to declaratively manage transactions.
 * 
 * <p> 此命名空间处理程序是Spring事务管理工具中的核心功能，并提供了两种以声明方式管理事务的方法。
 *
 ...
 * 
 * <p> 一种方法使用< tx：advice >中使用XML定义的事务语义。 元素，
 * 另一个使用注释结合< tx：annotation-driven > 元件。 两篇文章都在Spring参考手册中有详细说明。
 * 
 * @author Rob Harrop
