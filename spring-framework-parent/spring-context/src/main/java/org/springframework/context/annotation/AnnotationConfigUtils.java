 ...
 * 
 * <p> 实用程序类，允许方便地注册基于注解的配置的常见
 * org.springframework.beans.factory.config.BeanPostProcessor和
 * org.springframework.beans.factory.config.BeanFactoryPostProcessor定义。
 *
 * @author Mark Fisher
...
public class AnnotationConfigUtils {
	 ...
	 * 
	 * @param registry the registry to operate on - 操作的注册表
	 */
	 ...
	 * 
	 * <p> 从此触发此注册的配置源元素（已提取）。 可能为空。
	 * 
	 * @return a Set of BeanDefinitionHolders, containing all bean definitions
	 * that have actually been registered by this call
	 * 
	 * <p> 一组BeanDefinitionHolders，包含此调用实际已注册的所有bean定义
	 * 
	 */
